...
<div class="rightContainer">
    <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/crmstock/edit.html" id="form1"name="form1">
        ...
        <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
             data-parent="#accordion" href="#panelInfo">修改库存基本信息
        </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-md-11"><label class="form-control">${crm.number}</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="info col-md-1 text-right"><span class="red">*</span>商品名称:</td>
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="title" id="title" required value="${crm.title}"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" step="0.01" class="form-control" name="price" id="price" required value="${crm.price}"
                     ...
                     <tr>
                        ...
                        <td class="col-md-11">
                            <select name="unit" class="form-control" id="unit" required datatype="select">
                                <option value="${crm.unit}">${crm.unit==null?"无":crm.unit}</option>
                                <!--动态从数据库查数据并组合成option  -->
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="type" class="form-control type" id="type" required datatype="select">
                                <option value="${crm.type}" selected="selected">${crm.crmName.name}</option>
                                <!--动态从数据库查数据并组合成option  -->
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="stocknum" id="stocknum" value="${crm.stocknum}"
                     ...
                     <tr>
                        ...
                        <td class="col-md-11">
                            <select name="sid" class="form-control" id="sid" required datatype="select">
                                <option value="${crm.sid}" selected="selected">${crm.crmSupplier.supplier}</option>
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="snumber" id="snumber" value="${crm.snumber}"
