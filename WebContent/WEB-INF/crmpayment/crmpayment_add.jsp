		...
		<%@ include file="../top.jsp"%>
   		...
   		<div class="place">
    		...
    		<ul class="placeul">
				...
				<li><a href="<%=basePath%>manage/crmpayment/post.html">添加付款管理列表</a></li>
    		</ul>
    	</div>
		<div class="rightContainer">
        <script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js">
        </script>
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/crmpayment/post.html" id="userForm">
         			...
         			<div class="panel-body">
						<table class="table table-bordered">
							...
							<tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="sid" value="" maxlength="50" placeholder="请输入sid" autocomplete="off"   >
						    	</td>
						    </tr>
						    <tr>
						    	<td class="info col-md-1 text-right">perid:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="perid" value="" maxlength="50" placeholder="请输入perid" autocomplete="off"   >
						    	</td>
						    </tr>
						    ...
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="sname" value="" maxlength="50" placeholder="请输入sname" autocomplete="off"   >
						    	</td>
						    </tr>
