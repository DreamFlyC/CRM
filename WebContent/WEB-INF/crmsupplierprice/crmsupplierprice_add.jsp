...
<div class="rightContainer">
    <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/crmsupplierprice/post.html" id="form1"
          name="form1">
        <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
             data-parent="#accordion" href="#panelInfo">新增供应商商品报价信息
        </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="snumber" id="snumber" required value=""
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="seq" id="seq" value=""
