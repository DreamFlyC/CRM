...
<script src="<%=basePath%>resources/duty/js/jqplot.js"></script>
 <script type="text/javascript">
	...
	$.ajax({
		...
		success:function(result){
			...
			for(var i=0;i<result.msg.length;i++){
				count1.push(result.msg[i].count1);
				count2.push(result.msg[i].count2);
				count3.push(result.msg[i].count3);
				count4.push(result.msg[i].count4);
				count5.push(result.msg[i].count5);
				count6.push(result.msg[i].count6);
				count7.push(result.msg[i].count7);
				count8.push(result.msg[i].count8);
				count9.push(result.msg[i].count9);
				x.push(result.msg[i].days);
				//data.push();
			}
			//console.log(data);
			//console.log(x);
