...
<div class="place">
  ...
  <ul class="placeul">
    ...
    <li><a href="<%=basePath%>manage/foodsetmealitemstock/post.html">添加配方明细库存</a></li>
  </ul>
</div>
<div class="rightContainer">
  <script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js"></script>
  <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/foodsetmealitemstock/post.html"
        id="userForm" autocomplete="off">
    <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
         data-parent="#accordion" href="#panelInfo">添加配方明细库存
    </div>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="foodSetMealItemId" placeholder="请输入配方明细ID" nullmsg="请输入配方明细ID"
                     errormsg="配方明细ID至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="stockId" placeholder="请输入库存ID" nullmsg="请输入库存ID" errormsg="库存ID至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          <!-- end -->
        </table>
