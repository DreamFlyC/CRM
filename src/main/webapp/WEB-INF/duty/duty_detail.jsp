...
<div class="rightContainer">
  ...
  <form role="form" method="post" action="<%=basePath%>duty/edit_detail_duty" id="form1"
    ...
    <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse" data-parent="#accordion"
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input
                  class="form-control" style="  text-align: left;" type="text" name="enddate" id="enddate"
                  autocomplete="off"
                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss '})"
          ...
          <tr>
            ...
            <td class="col-md-11">
              <c:if test="${duty.appendix==null || duty.appendix==''}">
                ...
                <img id="titleFilebig" src="<%=basePath%>resources/images/no_file.gif" width="145" height="136"
