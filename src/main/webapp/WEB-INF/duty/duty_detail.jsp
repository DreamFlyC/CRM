            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="level" id="level" class="form-control">
                                <option value="${duty.level}"
                                        selected="selected">${duty.level==1?"普通":(duty.level==2?"紧急":"无")}</option>
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input
                                    class="form-control" style="  text-align: left;" type="text" name="startdate"
                                    id="startdate"
                                    autocomplete="off"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input
                                    class="form-control" style="  text-align: left;" type="text" name="enddate"
                                    id="enddate"
                                    autocomplete="off"
                                    onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss '})"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <c:if test="${duty.appendix==null || duty.appendix==''}">
                                <input type="file" name="file" id="titleFile" style="display:none"
                                       onchange="LW.util.uploadFile(this)">
                                <img id="titleFilebig" src="<%=basePath%>resources/images/no_file.gif" width="145"
                                     height="136"
                                     style="cursor:pointer" onclick="$('#titleFile').click()">
                            </c:if>
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <label
                                    class="form-control"
                                    style="  text-align: left;">${duty.dkey==1?"<span style='color:#0466cb;'>已完成</span>":(duty.dkey==2 ? "<span style='color:#09b4f9'>进行中</span>":"<span style='color:#EE0000;'>未接受</span>")}</label>
                        </td>
                    </tr>
                    <!--  <tr>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${shiroActionUsersGroupList}" var="dutyUsersGroup">
                                        ...
                                        <c:if test="${dutyUsernameList.size()>0}">
                                            <p data-id="${dutyUsersGroup.id}" data-name="${dutyUsersGroup.name}"
                                               id="s${dutyUsersGroup.id}">
                                                    ${dutyUsersGroup.name}
                                            </p>
                                        </c:if>
