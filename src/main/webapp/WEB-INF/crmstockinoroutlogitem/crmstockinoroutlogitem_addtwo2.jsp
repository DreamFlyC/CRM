...
<link
	href="<%=basePath%>resources/plugin/bootstrap3.3.2/css/bootstrap.min.css"
	rel="stylesheet" />
<link href="<%=basePath%>resources/css/system.css" rel="stylesheet"
	type="text/css" />
...
<script
	src="<%=basePath%>resources/plugin/bootstrap3.3.2/js/bootstrap.min.js"></script>
...
<script
	src="<%=basePath%>resources/duty/js/My97DatePicker/WdatePicker.js"></script>
	
	 <link rel="stylesheet" href="//apps.bdimg.com/libs/jqueryui/1.10.4/css/jquery-ui.min.css">
<title>${appName}_出货记录明细</title>
...
<body >
	...
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a
				href="<%=basePath%>manage/crmstockinoroutlogitem/crmstockinoroutlogitem_list.html">出货记录明细列表</a></li>
			<li>添加明细</li>
			<li>
	...
	<div class="rightContainer">
		...
		<form class="form-horizontal" role="form" method="post"
			...
			<div class="list-group-item active glyphicon glyphicon-chevron-up" 
				data-toggle="collapse" data-parent="#accordion" href="#panelInfo">新增出货记录明细</div>
			<div id="panelInfo" class="panel-collapse collapse in">
				<div class="panel-body">
					<table class="table table-bordered">
						<tr>
							<td class="info col-md-1 text-right"><span class="red">*</span>编号:</td>
						...
						<tr>
							<td class="info col-md-1 text-right"><span class="red">*</span>总价格:</td>
							<td class="col-md-11">
							
							<input type="number" step="0.01"
								class="form-control" name="price" id="price" value="0"
								maxlength="50" placeholder="0" autocomplete="off" nullmsg="总价格不能为空"
								datatype="*1-50" errormsg="至少1个字符,最多50个字符！"></td>
						</tr>
						<tr>
						...
						<tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>指定领取人员:</td>
						    	<td class="col-md-11">
						...
						<!-- <tr>
							<td class="info col-md-1 text-right"><span class="red">*</span>takeuid:</td>
							<td class="col-md-11"><input type="text"
								class="form-control" name="takeuid" value="" maxlength="50"
								nullmsg="指定takeuid" placeholder="指定takeuid" autocomplete="off"
								datatype="*1-50" errormsg="至少1个字符,最多50个字符！"></td>
						</tr> -->
						<tr>
			...
			<div class="modal-content"><!--  style="width:800px; height: 550px;" -->
				...
				<div class="modal-body"><!--  style="height: 428px;" -->
					<div class="nav">
						...
						<table class="table ">
							<tr>
								<td class="info col-md-2 text-right"><span class="red">*</span>编号:</td>

								<td class="col-md-11 " colspan="2"><label class="form-control text-left"
							...
							<tr>
								...
								<td class="col-md-11" colspan="2">
								<label id="priceitem1" class="form-control text-left"></label>
							...
							<tr>
								...
								<td class="col-md-11" colspan="2"><select name="type" id="typeitem"	
									class="form-control">
							...
							<!-- <tr>
								<td class="info col-md-2 text-right"><span class="red">*</span>pid:</td>
								<td class="col-md-11" colspan="2"><input type="number"
									class="form-control" name="pid" id="piditem" value=""
									maxlength="50" nullmsg="pid" placeholder="pid"
							...
							<!-- <tr>
								<td class="info col-md-2 text-right"><span class="red">*</span>inorout_log_no:</td>
								<td class="col-md-11" colspan="2"><input type="number"
									class="form-control" name="inoroutlogno" id="inoroutlognoitem"
									value="" maxlength="50" nullmsg="inorout_log_no"
									placeholder="inorout_log_no" autocomplete="off"
									datatype="*1-50" errormsg="至少1个字符,最多50个字符！"></td>
							</tr>
							<tr>
								<td class="info col-md-2 text-right"><span class="red">*</span>地址:</td>
								<td class="col-md-11" colspan="2"><input type="text"
									class="form-control" name="address" id="addressitem" value=""
									maxlength="300" autocomplete="off" datatype="*1-300"
									errormsg="至少1个字符,最多300个字符！"></td>
							</tr> -->
							<tr>
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<input type="hidden" step="0.01"
									...
									maxlength="50" placeholder="请输入产品价格" autocomplete="off"
									datatype="*1-50" errormsg="至少1个字符,最多50个字符！"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="col-md-11"><input type="number"
									class="form-control" name="pid" id="pidedit" value=""
									maxlength="50" nullmsg="pid" placeholder="pid"
									autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
								</td>
							</tr>
							<tr>
								<td class="info col-md-1 text-right"><span class="red">*</span>出货数量:</td>
								<td class="col-md-11"><input type="number"
							...
							<!-- <tr>
								...
								<td class="col-md-11"><input type="number"
									class="form-control" name="inoroutlogno" id="inoroutlognoedit"
									value="" maxlength="50" nullmsg="inorout_log_no"
									placeholder="inorout_log_no" autocomplete="off"
									datatype="*1-50" errormsg="至少1个字符,最多50个字符！"></td>
							</tr>
							<tr>
								<td class="info col-md-1 text-right"><span class="red">*</span>地址:</td>
								<td class="col-md-11"><input type="text"
									class="form-control" name="address" id="addressedit" value=""
									maxlength="300" autocomplete="off" datatype="*1-300"
									errormsg="至少1个字符,最多300个字符！"></td>
							</tr> -->
							<tr>
				...
				if(key){
					$.ajax({
						...
						data:{
							...
							/* "inoroutlogno":$("#inoroutlognoitem").val(),
						    ...
						    success : function() {
						    	...
						    	$.get("manage/crmstockinoroutlogitem/getlistbynumber",
				                        ...
				                        for(var i=0;i<data.msg.length;i++)
											...
											result+="<td id='numbershow'>"+data.msg[i].number+"</td>";
											result+="<td id='titleshow'>"+data.msg[i].title+"</td>";
											result+="<td id='priceshow'>"+data.msg[i].price+"</td>";
											result+="<td id='typeshow'>"+data.msg[i].type+"</td>";
											result+="<td id='dateshow'>"+new Date(data.msg[i].date).format('yyyy-MM-dd hh:mm:ss')+"</td>";
											result+="<td id='uidshow'>"+data.msg[i].uid+"</td>";
											result+="<td id='pidshow'>"+data.msg[i].pid+"</td>";
											result+="<td id='numshow'>"+data.msg[i].num+"</td>";
											/* result+="<td id='inoroutlognoshow'>"+data.msg[i].inoroutlogno+"</td>";
											result+="<td id='addressshow'>"+data.msg[i].address+"</td>"; */
											result+="<td id='noteshow'>"+data.msg[i].note+"</td>";                            
											result+="<td>";
	...
	<script>
		function editmodal(id){
			...
			$("#edit").click(function(){
				...
				if(key){
					$.ajax({
						url:"manage/crmstockinoroutlogitem/edit?id="+id,
						data:{
					    ...
					    //	LW.message.show('提交成功 ');
					    	...
					    	$.ajax({
								...
								success:function(data){
									 $("idshow").html(id);	
									 $("#titleshow").html(data.msg.title);
									 $("#priceshow").html(data.msg.price);
									 $("#typeshow").html(data.msg.type);
									 $("#pidshow").html(data.msg.pid);
									 $("#numshow").html(data.msg.num);
									 $("#inoroutlognoshow").html(data.msg.inoroutlogno);
									 $("#addressshow").html(data.msg.address);
									 $("#noteshow").html(data.msg.note);
								}
							});
	...
	function onunload_handler(){ 
     ...
     //自动完成
     function AutoComplete(auto, search, mytitle_list,myprice_list,mytype_list)
     {
         if ($("#" + search).val() != old_value || old_value == "")
         {
             ...
             for (i in titlelist) 
             {
                 ...
                 var newDivNode = $("<div>").attr("id", i).attr("data-price",priceNode).attr("data-type",typeNode);    //设置每个节点的id值
     ...
     $(function () {
         ...
         $("#titleitem").focus(function () {
             if ($("#titleitem").val() == "") {
                 AutoComplete("auto_div", "titleitem", title_list,price_list,type_list);
