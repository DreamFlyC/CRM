...
<div class="rightContainer">
    <form class="form-horizontal" role="form" method="post"
          action="<%=basePath%>manage/crmstockinoroutlogitem/edit.html" id="form1" name="form1">
        ...
        <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
             data-parent="#accordion" href="#panelInfo">新增进出货记录明细
        </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="title" id="title"
                                   value="${crmStockInorOutLogItem.title}" maxlength="50" placeholder="请输入名称"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="price" id="price"
                                   value="${crmStockInorOutLogItem.price}"
                                   maxlength="50" placeholder="请输入价格" autocomplete="off" datatype="*1-50"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <select name="type" class="form-control">
                                <option value="${crmStockInorOutLogItem.type}"
                                        selected="selected">${crmStockInorOutLogItem.crmName.name}</option>
                                <!--动态从数据库查数据并组合成option  -->
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="pid" value="${crmStockInorOutLogItem.pid}"
                                   maxlength="50" nullmsg="pid" placeholder="pid" autocomplete="off" datatype="*1-50"
                                   errormsg="至少1个字符,最多50个字符！">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="num" value="${crmStockInorOutLogItem.num}"
                                   maxlength="50" nullmsg="请填写数量" placeholder="数量" autocomplete="off" datatype="*1-50"
                                   errormsg="至少1个字符,最多50个字符！">
                        </td>
                    </tr>
                    <%--   <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="text" class="form-control" name="note" id="note"
                                   value="${crmStockInorOutLogItem.note}" maxlength="300" autocomplete="off"
                                   datatype="*1-300" errormsg="至少1个字符,最多300个字符！">
                        </td>
                    </tr>
                </table>
