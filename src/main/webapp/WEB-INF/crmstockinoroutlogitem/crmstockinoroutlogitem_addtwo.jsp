...
<div class="rightContainer">
  <form class="form-horizontal" role="form" method="post"
    ...
    <div class="list-group-item active glyphicon glyphicon-chevron-up"
         data-toggle="collapse" data-parent="#accordion" href="#panelInfo">新增进出货记录明细
    </div>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr style="display: none" id="showuser">
            ...
            <td class="col-md-11">
              <label id="choose1" class="form-control" style="text-align: left;" data-toggle="modal"
                     data-target="#myModaltakeuid">请选择人员</label>
      ...
      <div class="modal-body"><!--  style="height: 428px;" -->
        <div class="nav">
          ...
          <table class="table ">
            ...
            <div class="stockitem" id="stockitem"></div>

            <tr>
              <td class="info col-md-2 text-right"><span class="red">*</span>生产日期:</td>
              <td class="col-md-11" colspan="2">
                <input type="text" name="productTime" id="productTimeitem" style="text-align: left;"
                       placeholder="请输入生产日期" autocomplete="off"
            ...
            <tr>
              <td class="info col-md-2 text-right"><span class="red">*</span>保质期（天）:</td>
              <td class="col-md-11" colspan="2">
                <input type="number" name="shelfLife" id="shelfLifeitem" style="text-align: left;"
                       placeholder="请输入保质期（单位：天）" autocomplete="off"
                       class="form-control"/>
              </td>
            </tr>
...
<script type="text/javascript">
    $("#submit").click(function () {
        ...
        if ($("#productTimeitem").val() == "") {
            LW.message.show("请输入生产日期");
            key = false;
            return false;
        }
        if ($("#shelfLifeitem").val() == "") {
            LW.message.show("请输入保质期（单位：天）");
            key = false;
            return false;
        }
        if ($("#numitem").val() == "") {
        ...
        if (key) {
            $.ajax({
                ...
                data: {
                    ...
                    "productTime": $("#productTimeitem").val(), "shelfLife": $("#shelfLifeitem").val(),
                },
                error: function () {
              ...
              <c:choose>
                ...
                <c:otherwise>
                  ...
                  <c:forEach items="${dutyUsernameList}" var="dutyUsername">
                    <div class="btn btn-default" id="u${dutyUsername.id}" data-id="${dutyUsername.id}"
                         data-name="${dutyUsername.user}"
                         onclick="addUser(${dutyUsername.id})">${dutyUsername.user}</div>
                  </c:forEach>
