...
<div class="place">
  ...
  <ul class="placeul">
    ...
    <li><a href="<%=basePath%>manage/memberdoorauthoritylog/post.html">添加开门权限日记管理</a></li>
  </ul>
</div>
<div class="rightContainer">
  <script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js"></script>
  <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/memberdoorauthoritylog/post.html"
        id="userForm" autocomplete="off">
    <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
         data-parent="#accordion" href="#panelInfo">添加开门权限日记管理
    </div>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="memberId" placeholder="请输入member_id" nullmsg="请输入member_id"
                     errormsg="member_id至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="doorId" placeholder="请输入door_id" nullmsg="请输入door_id" errormsg="door_id至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" name="loginTime" id="loginTime" style="text-align: left;"
                     placeholder="请输入登录时间" autocomplete="off"
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="status" placeholder="请输入状态" nullmsg="请输入状态" errormsg="状态至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          <!-- end -->
        </table>
