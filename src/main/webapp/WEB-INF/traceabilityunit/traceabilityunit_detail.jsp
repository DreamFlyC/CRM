...
<div class="place">
  ...
  <ul class="placeul">
    ...
    <li><a href="<%=basePath%>manage/traceabilityunit/post.html">修改溯源单位</a></li>
  </ul>
</div>
<div class="rightContainer">
  <script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js"></script>

  <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/traceabilityunit/edit.html"
        id="userForm" autocomplete="off">
    <input type="hidden" name="id" value="${traceabilityUnit.id}"/>
    <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
         data-parent="#accordion" href="#panelInfo">修改溯源单位
    </div>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" maxlength="50" datatype="*1-50"
                     name="name" value="${traceabilityUnit.name}" placeholder="请输入名称" nullmsg="请输入名称"
                     errormsg="名称至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" maxlength="50" datatype="*1-50"
                     name="seq" value="${traceabilityUnit.seq}" placeholder="请输入排序" nullmsg="请输入排序"
                     errormsg="排序至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="number" class="form-control" maxlength="50" datatype="*1-50"
                     name="type" value="${traceabilityUnit.type}" placeholder="请输入类型" nullmsg="请输入类型"
