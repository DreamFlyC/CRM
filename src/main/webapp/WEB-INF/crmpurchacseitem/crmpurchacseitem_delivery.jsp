...
<div style="text-align: center">
  <input type="button" class="btn btn-success" name="button_export" value="打&nbsp;印" onclick="preview(1)"/>
</div>
<script>
    $(function () {
        var num = 0;
        ...
        for (i = part[0].length - 1; i >= 0; i--) {
            ...
            switch (part[0].length - i - 1) {
                case 0:
                    ...
                    break;
                case 1:
                    if (0 !== perchar) tmpnewchar = tmpnewchar + "拾";
                    break;
                case 2:
                    if (0 !== perchar) tmpnewchar = tmpnewchar + "佰";
                    break;
                case 3:
                    if (perchar == 0) {
                    } else {
