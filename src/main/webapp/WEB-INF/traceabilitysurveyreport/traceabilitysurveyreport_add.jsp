...
<div class="place">
  ...
  <ul class="placeul">
    ...
    <li><a href="<%=basePath%>manage/traceabilitysurveyreport/post.html">添加溯源产品检测报告</a></li>
  </ul>
</div>
<div class="rightContainer">
  <script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js"></script>
  <form class="form-horizontal" role="form" method="post"
        action="<%=basePath%>manage/traceabilitysurveyreport/post.html"
        id="userForm" autocomplete="off">
    <div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
         data-parent="#accordion" href="#panelInfo">添加溯源产品检测报告
    </div>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="userId" placeholder="请输入用户ID" nullmsg="请输入用户ID" errormsg="用户ID至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="remark" placeholder="请输入备注" nullmsg="请输入备注" errormsg="备注至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="codeNumber" placeholder="请输入检验报告编码" nullmsg="请输入检验报告编码" errormsg="检验报告编码至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="producerId" placeholder="请输入生产者ID" nullmsg="请输入生产者ID" errormsg="生产者ID至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="purchaserId" placeholder="请输入购买者D" nullmsg="请输入购买者D" errormsg="购买者D至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" class="form-control" value="" maxlength="50" datatype="*1-50"
                     name="status" placeholder="请输入检验结果 -1 不合格  1 合格   0为默认" nullmsg="请输入检验结果 -1 不合格  1 合格   0为默认"
                     errormsg="检验结果 -1 不合格  1 合格   0为默认至少1个字符,最多50个字符！"/>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="col-md-11">
              <input type="text" name="makeDate" id="sdate" style="text-align: left;"
