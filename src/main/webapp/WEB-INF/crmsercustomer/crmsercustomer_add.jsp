...
<html>
	...
	<body>
		...
		<div class="rightContainer">
			<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/crmsercustomer/post.html" id="userForm">
						...
						<table class="table table-bordered">
						    <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="number" class="form-control" name="cid" value="" maxlength="50" nullmsg="请输入公司id" placeholder="请输入公司id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>类型:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="type" value="" maxlength="50" nullmsg="请输入类型" placeholder="请输入类型" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="number" class="form-control" name="uid" value="" maxlength="50" nullmsg="录入人员id" placeholder="录入人员id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						    	<td class="info col-md-1 text-right"><span class="red">*</span>指定回访人员id:</td>
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="follow_uid" value="" maxlength="50" nullmsg="指定回访人员id" placeholder="指定回访人员id" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="number" class="form-control" name="follow_purpose" value="" maxlength="50" nullmsg="回访目的" placeholder="回访目的" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
						     <tr>
						     ...
						     <tr>
						    	...
						    	<td class="col-md-11">
						    		<input type="text" class="form-control" name="follow_result" value="" maxlength="50" nullmsg="回访结果" placeholder="回访结果" autocomplete="off" datatype="*1-50" errormsg="至少1个字符,最多50个字符！">
						    	</td>
						    </tr>
    	...
    	<script type="text/javascript">
			$("#page_crmname_list").parent().attr("class","active");
