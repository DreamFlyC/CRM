...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="<%=basePath%>manage/lgsdoorinfo/post.html">修改柜门管理</a></li>
	</ul>
</div>
<div class="rightContainer">
	<script src="<%=basePath%>resources/My97DatePicker/WdatePicker.js"></script>

	<form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/lgsdoorinfo/edit.html"
		  id="userForm">
		<input type="hidden" name="id" value="${lgsDoorInfo.id}" />
		<div class="list-group-item active glyphicon glyphicon-chevron-up" data-toggle="collapse"
			 data-parent="#accordion" href="#panelInfo">修改柜门管理
		</div>
...
name="name" value="${lgsDoorInfo.name}" placeholder="请输入name" nullmsg="请输入name" errormsg="name至少1个字符,最多50个字符！" />
</td>
</tr>
...
<td class="col-md-11">
<input type="text" class="form-control" maxlength="50" datatype="*1-50"
name="doorNo" value="${lgsDoorInfo.doorNo}" placeholder="请输入door_no" nullmsg="请输入door_no" errormsg="door_no至少1个字符,最多50个字符！" />
</td>
</tr>
...
<td class="col-md-11">
<input type="text" class="form-control" maxlength="50" datatype="*1-50"
name="remark" value="${lgsDoorInfo.remark}" placeholder="请输入remark" nullmsg="请输入remark" errormsg="remark至少1个字符,最多50个字符！" />
</td>
</tr>
<!-- end -->
				</table>
