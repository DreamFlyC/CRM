  ...
  <form action="manage/crmstock/crmstock_list" method="post" onsubmit="return isValid(this)"
    ...
    <div style="margin:20px 0px;">
      <div class="col-md-5">
        ...
        <input type="text" name="keyword" id="keyword" autocomplete="off" placeholder="输入商品编号、商品名称、供应商编号"
      ...
      <div class="col-md-5" style="position: relative;">
        ...
        <input type="text" name="supplier" id="titleitem" autocomplete="off" placeholder="输入供应商名称" maxlength="20"
               onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5a-zA-Z0-9\w]/g,'')"
