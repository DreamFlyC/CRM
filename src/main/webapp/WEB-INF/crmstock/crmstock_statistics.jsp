...
<div class="rightContainer">
  ...
  <div style="margin:20px 0px;">
    ...
    <div class="col-md-3" style="position: relative;">
      <input type="text" name="sDate" id="sDate" autocomplete="off" placeholder="开始时间" maxlength="20"
    ...
    <div class="col-md-3" style="position: relative;">
      <input type="text" name="eDate" id="eDate" autocomplete="off" placeholder="结束时间" maxlength="20"
             onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5a-zA-Z0-9\w]/g,'')"
             class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="">
