...
<div class="rightContainer">
    <form class="form-horizontal" role="form" method="post" action="<%=basePath%>manage/crm/save" id="form1"name="form1">
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="price" id="price" required value="${crm.price}"
                    ...
                    <tr>
                        ...
                        <td class="col-md-11">
                            <input type="number" class="form-control" name="snumber" id="stocknum" value="${crm.snumber}"
